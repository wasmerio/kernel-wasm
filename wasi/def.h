...
_Static_assert(offsetof(__wasi_prestat_t, u.dir.pr_name_len) == 4, "non-wasi data layout");
...
typedef struct __wasi_ciovec_t {
    const wasm_pointer_t buf;
    uint32_t buf_len;
} __wasi_ciovec_t;
_Static_assert(offsetof(__wasi_ciovec_t, buf) == 0, "non-wasi data layout");
_Static_assert(offsetof(__wasi_ciovec_t, buf_len) == 4, "non-wasi data layout");
_Static_assert(sizeof(__wasi_ciovec_t) == 8, "non-wasi data layout");
_Static_assert(_Alignof(__wasi_ciovec_t) == 4, "non-wasi data layout");
...
_Static_assert(offsetof(__wasi_iovec_t, buf_len) == 4, "non-wasi data layout");
_Static_assert(sizeof(__wasi_iovec_t) == 8, "non-wasi data layout");
_Static_assert(_Alignof(__wasi_iovec_t) == 4, "non-wasi data layout");
